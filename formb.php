	...
	<div id="layoutSidenav">
				...
				<div class="sb-sidenav-menu">
					<div class="nav">
						...
						<div class="collapse" id="collapseLayouts" aria-labelledby="headingOne"
							...
							<nav class="sb-sidenav-menu-nested nav"><a class="nav-link" href="register.html">Registro de
									Cliente </a><a class="nav-link" href="register.html">Actualizar Cliente</a> <a
									class="nav-link" href="register.html">Eliminar Cliente</a></nav>
						</div>
		...
		<div id="layoutSidenav_content">
			<main>
					...
					<form action="busc.php" method="post">
						<input type="text" name="website" placeholder="Digite su Website"required>
						<input type="submit"  class="btn-primary" value="Buscar" ></div>
					</form>
